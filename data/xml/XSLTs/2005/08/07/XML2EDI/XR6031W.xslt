...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/sundcom.dk/medcom.dk/xml/schemas/2005/08/07/" version="1.0">
	...
	<xsl:template match="m:PrescriptionRequest">
		...
		<xsl:variable name="PrefPharmacy" select="m:PreferredPharmacy"/>
			...
			<BrevIndhold>
				...
				<S01 hidden="true">
					...
					<PNA>
						...
						<Elm>
						  <xsl:if test="$Issuer/m:AuthorisationIdentifier">
								<SubElm>
						...
						<EMP>
							...
							<Elm>
								<SubElm>
									...
									<xsl:choose>
										<xsl:when test="$Occ='tandlaege'">DEN</xsl:when>
