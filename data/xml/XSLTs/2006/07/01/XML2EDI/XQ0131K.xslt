			...
			<BrevIndhold>
				...
				<S01>
					...
					<NAD>
						<Elm>
						        <xsl:choose>
						          <xsl:when test="$Participant/m:ReplyTo = 'true'">
						            <SubElm>PO</SubElm>
						          </xsl:when>
						          <xsl:otherwise>
						            <SubElm>ONL</SubElm>
			 ...
			 <xsl:otherwise>
				...
				<S02>
					...
					<RFF>
						<Elm>
						  ...
						  <xsl:if test="$ReqInfo/m:Sample/m:SampleIdentifierType">
						    <SubElm/>
						    <SubElm>
						      <xsl:text>NPN</xsl:text>
						    </SubElm>
						  </xsl:if>
						</Elm>
					</RFF>
				  <xsl:if test="$ReqInfo/m:Sample/m:OriginalRequesterSampleIdentifier">
				  <RFF>
				    <Elm>
				      <SubElm>OOI</SubElm>
				      <SubElm>
				        <xsl:value-of select="$ReqInfo/m:Sample/m:OriginalRequesterSampleIdentifier"/>
				      </SubElm>
				      <xsl:if test="$ReqInfo/m:Sample/m:SampleIdentifierType">
				        <SubElm/>
				        <SubElm>
					...
					<DTM>
						<Elm>
							...
							<SubElm>
								<xsl:call-template name="DateTimeToDTM203">
								  <xsl:with-param name="DT" select="$ReqInfo/m:RequisitionDateTime"/>
								</xsl:call-template>
							</SubElm>
							<SubElm>203</SubElm>
						</Elm>
					...
					<xsl:for-each select="$ReqInfo/m:SamplingLocation">
						<XFTX>
							<Elm>
								<SubElm>EXT</SubElm>
							</Elm>
					    ...
					    <INV>
					      ...
					      <Elm>
					        ...
					        <SubElm>
					          ...
					          <xsl:choose>
					            <!--<xsl:when test="$CT='iupac' ">CQU</xsl:when>-->
						...
						<Elm>
							<SubElm>
								...
								<xsl:choose>
									...
									<xsl:when test="$SLC='laboratoriet_eksternt'">EXT</xsl:when>
							...
							<Elm>
								<SubElm>
									...
									<xsl:choose>
										...
										<xsl:when test="$SLC='laboratoriet_eksternt'">RCS</xsl:when>
										<xsl:otherwise>
											<FEJL>Ukendt SamplingLocationCode: <xsl:value-of select="$SLC"/>
											</FEJL>
										</xsl:otherwise>
				...
				<xsl:for-each select="$ReqAnas">
					<S17 hidden="true">
						...
						<xsl:for-each select="m:Analysis">
							<INV>
								...
								<Elm>
									...
									<SubElm><xsl:value-of select="m:AnalysisShortName"/></SubElm>
								</Elm>
							</INV>
							<xsl:for-each select="m:LineComment">
								<FTX>
									<Elm>
										<SubElm>ACM</SubElm>
									</Elm>
									...
									<Elm/>
									<Elm>
										<xsl:for-each select="m:TextLine">
						...
						<xsl:for-each select="m:SampleLocation">
							<FTX>
								<Elm>
									<SubElm>SRC</SubElm>
								</Elm>
						...
						<xsl:for-each select="m:SampleMaterial">
							<FTX>
								<Elm>
									<SubElm>SMA</SubElm>
								</Elm>
						...
						<xsl:for-each select="m:TestTubeIdentifier">
							<RFF>
								<Elm>
								  <SubElm>SID</SubElm><SubElm><xsl:value-of select="."/></SubElm>
