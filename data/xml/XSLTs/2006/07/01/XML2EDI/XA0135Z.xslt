									...
									<Elm>
										<SubElm>
											...
											<xsl:choose>
												...
												<xsl:when test="$LTC='ydernummer'">10</xsl:when>
												<xsl:when test="$LTC='proevetagningstidspunkt'">11</xsl:when>
												<xsl:when test="$LTC='glasgruppenummer'">12</xsl:when>
												<xsl:when test="$LTC='cprnummer'">13</xsl:when>
												<xsl:otherwise>
