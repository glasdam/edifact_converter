            ...
            <Envelope>
                <Sent>
                    <Date>
                        ...
                        <xsl:if test="substring($D,1,2)&lt;=20">20</xsl:if>
                        <xsl:if test="substring($D,1,2)>20">19</xsl:if>
                        <xsl:value-of select="concat(substring($D,1,2),'-',substring($D,3,2),'-',substring($D,5,2))"/>
                    </Date>
                    <Time>
                ...
                <Identifier>
                    <xsl:value-of select="$Unb/Elm[5]/SubElm[1]"/>
                </Identifier>
                <AcknowledgementCode>
