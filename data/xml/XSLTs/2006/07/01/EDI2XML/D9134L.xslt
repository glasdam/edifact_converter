...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://rep.oio.dk/sundcom.dk/medcom.dk/xml/schemas/2006/07/01/">
    ...
    <xsl:template match="Brev[UNH/Elm[2][SubElm[1]='MEDDIS' and SubElm[5]='D9134L']]">
        ...
        <ClinicalEmail>
            <xsl:for-each select="$S02LetterInfo">
                <Letter>
                    ...
                    <VersionCode>XD9134L</VersionCode>
                    <StatisticalCode>XDIS91</StatisticalCode>
