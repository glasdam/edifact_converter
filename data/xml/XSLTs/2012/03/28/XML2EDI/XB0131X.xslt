<?xml version="1.0"?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2012/03/28/" version="1.0">
				...
				<xsl:for-each select="$BinObjs">
						<UNO>
							...
							<Elm>
								<SubElm>AID</SubElm>
								<SubElm>
									<xsl:variable name="uuid" select="m:ObjectIdentifier"/>
									<xsl:value-of select="translate($uuid, '-', '')"/>
								</SubElm>
							</Elm>
							<Elm>
								<SubElm>OBJ</SubElm>
