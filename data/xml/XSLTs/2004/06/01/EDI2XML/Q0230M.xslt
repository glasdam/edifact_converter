...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://rep.oio.dk/medcom.dk/xml/schemas/2004/06/01/">
	...
	<xsl:template match="Brev[UNH/Elm[2][SubElm[1]='MEDREQ' and SubElm[5]='Q0230M']]">
		...
		<MicrobiologyRequest>
			<Letter>
				...
				<VersionCode>XQ0230M</VersionCode>
				<StatisticalCode>XREQ02</StatisticalCode>
				<xsl:for-each select="$Dtm">
					<Authorisation>
						<xsl:call-template name="DTM203ToDateTime"/>
					</Authorisation>
				</xsl:for-each>
				<TypeCode>XREQ02</TypeCode>
			</Letter>
			...
			<RequisitionInformation>
				...
				<xsl:for-each select="$S02LetterInfo/FTX">
					<Comments>
						<xsl:call-template name="FTXSegmentsToBreakableText"/>
					</Comments>
				</xsl:for-each>
