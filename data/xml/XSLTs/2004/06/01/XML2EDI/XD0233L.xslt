...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2004/06/01/" version="1.0">
	...
	<!-- DISCHARGELETTER -->
	<xsl:template match="m:OutPatientDischargeLetter">
		...
		<xsl:variable name="OutPatientFirstVisit" select="m:OutPatientFirstVisit"/>
		<xsl:variable name="OutPatientLastVisit" select="m:OutPatientLastVisit"/>
		...
		<Brev>
			...
			<BrevIndhold>
						...
						<Elm>
							<SubElm>
								<xsl:if test="count($Participant/m:MedicalSpecialityCode)=1">
									<xsl:apply-templates select="$Participant/m:MedicalSpecialityCode"/>
								</xsl:if>
							</SubElm>
							<SubElm>SKS</SubElm>
							<SubElm>SST</SubElm>
				...
				<S11>
					...
					<xsl:if test="count($OutPatientFirstVisit)=1">
						<DTM>
							<Elm>
								<SubElm>90</SubElm>
								<SubElm>
									<xsl:call-template name="DateTimeToDTM203">
										<xsl:with-param name="DT" select="$OutPatientFirstVisit"/>
									</xsl:call-template>
								</SubElm>
								<SubElm>203</SubElm>
							</Elm>
					...
					<xsl:if test="count($OutPatientLastVisit)=1">
						<DTM>
							<Elm>
								<SubElm>91</SubElm>
								<SubElm>
									<xsl:call-template name="DateTimeToDTM203">
										<xsl:with-param name="DT" select="$OutPatientLastVisit"/>
									</xsl:call-template>
								</SubElm>
								<SubElm>203</SubElm>
							</Elm>
