		...
		<Brev>
			...
			<BrevIndhold>
				...
				<S01 hidden="true">
					...
					<PNA>
						...
						<Elm>
							<xsl:if test="$Issuer/m:CivilRegistrationNumber!='' ">
								<SubElm>
									<xsl:value-of select="$Issuer/m:CivilRegistrationNumber"/>
								</SubElm>
								<SubElm>CPR</SubElm>
							</xsl:if>
						</Elm>
					...
					<xsl:if test="count($Participant/m:MedicalSpecialityCode)>0">
						<SPR>
							<Elm>
								<SubElm>HC</SubElm>
							</Elm>
				...
				<S02 hidden="true">
					...
					<xsl:if test="$PatOrRel/m:PrivateInsurance='true' ">
						<ICD>
							<Elm>
								<SubElm>DK</SubElm>
								<SubElm>SKL</SubElm>
					...
					<xsl:if test="$PatOrRel/m:LocalAuthorityGrant='true'">
						<ICD>
							<Elm>
								<SubElm>MK</SubElm>
								<SubElm>SKL</SubElm>
					...
					<S03 hidden="true">
						...
						<PNA>
							...
							<Elm>
								...
								<SubElm><xsl:if test="count(m:CivilRegistrationNumber)>0">CPR</xsl:if></SubElm>
							</Elm>
							<Elm>
							</Elm>
							<Elm/>
					...
					<S04 hidden="true">
						...
						<CIN>
							...
							<Elm>
								...
								<SubElm><xsl:if test="count(m:Indication/m:Code)>0">LDD</xsl:if></SubElm>
								<SubElm><xsl:if test="count(m:Indication/m:Code)>0">LMS</xsl:if></SubElm>
								<SubElm>
							...
							<xsl:for-each select="m:Dosage">
								<DSG>
									...
									<Elm>
										...
										<SubElm><xsl:if test="count(m:DosageCode)>0">LDD</xsl:if></SubElm>
										<SubElm><xsl:if test="count(m:DosageCode)>0">LMS</xsl:if></SubElm>
										<SubElm>
