...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2004/06/01/" version="1.0">
	...
	<xsl:template name="VersionCodeToType">
		...
		<xsl:choose>
			...
			<xsl:when test="$VersionCode='SST012' ">MEDPRE</xsl:when>
			...
			<xsl:when test="$VersionCode='XU0130U' ">????</xsl:when>
			<xsl:when test="$VersionCode='XU0230U' ">????</xsl:when>
			<xsl:when test="$VersionCode='XU0330U' ">????</xsl:when>
			<xsl:when test="$VersionCode='XU0430U' ">????</xsl:when>
			<xsl:when test="$VersionCode='XU0530U' ">????</xsl:when>
			...
			<xsl:when test="$VersionCode='XI0130D' ">????</xsl:when>
			<xsl:when test="$VersionCode='XI0230D' ">????</xsl:when>
			<xsl:when test="$VersionCode='XI0330D' ">????</xsl:when>
			<xsl:when test="$VersionCode='XI0430D' ">????</xsl:when>
			<xsl:when test="$VersionCode='XSST012' ">XMEDPRE</xsl:when>
			<xsl:when test="$VersionCode='LMS015' ">MEDPRE</xsl:when>
			<xsl:when test="$VersionCode='XLMS015' ">XMEDPRE</xsl:when>
