								...
								<FTX>
									...
									<Elm>
										<SubElm>
											...
											<xsl:choose>
												<xsl:when test="$LTC='uspecificeret'">0</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_standard'">1</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_proevetagningstidspunkt'">2</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_glasgruppenavn'">3</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_cprnummer'">4</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_cpr_patientnavn'">5</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_blodbank'">6</xsl:when>
												<xsl:when test="$LTC='klinisk_kemi_venstrestillet'">7</xsl:when>
												<xsl:when test="$LTC='mikrobiologi_standard'">8</xsl:when>
												<xsl:when test="$LTC='patologi_standard'">9</xsl:when>
												<xsl:otherwise>
