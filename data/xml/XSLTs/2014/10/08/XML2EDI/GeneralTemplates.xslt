...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2014/10/08/" version="1.0">
	...
	<xsl:template name="VersionCodeToType">
		...
		<xsl:choose>
			<xsl:when test="$VersionCode='XR0131K' ">XMEDRPT</xsl:when>
			<xsl:when test="$VersionCode='XR0331P' ">XMEDRPT</xsl:when>
			<xsl:when test="$VersionCode='XR0432P' ">XMEDRPT</xsl:when>
			<xsl:when test="$VersionCode='XR0532M' ">XMEDRPT</xsl:when>
			<xsl:when test="$VersionCode='XR0730G' ">XMEDRPT</xsl:when>
			<xsl:when test="$VersionCode='XR0130F' ">XMEDRPT</xsl:when>
			<xsl:when test="$VersionCode='XA0140Z' ">XPRODAT</xsl:when>
			<xsl:when test="$VersionCode='XQ0331P' ">XMEDREQ</xsl:when>
