...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
              ...
              <tr>
                <td valign="top" width="100%">
                  <table>
                    ...
                    <tr>
                      <td>
                        <xsl:call-template name="MicroReport_Comment"/>
                      </td>
                    </tr>
                    </xsl:for-each>
                  </table>
  ...
  <xsl:template name="MicroReport_Comment">
      ...
      <xsl:for-each select="m:Investigation">
        <xsl:element name="div">
          ...
          <xsl:for-each select="m:CultureFindings">
            <xsl:call-template name="MicroReport_cultureFindingsTable"/>
          </xsl:for-each>
  ...
  <xsl:template name="MicroReport_cultureFindingsTable">
