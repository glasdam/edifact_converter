...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="http://rep.oio.dk/medcom.dk/xml/schemas/2008/09/17/">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>
	<xsl:template match="Brev[UNH/Elm[2][SubElm[1]='MEDDIS' and SubElm[5]='D1034L']]">
		...
		<PsychologistLetter>
			<xsl:for-each select="$S02LetterInfo">
				<Letter>
					...
					<VersionCode>XD1034L</VersionCode>
					<StatisticalCode>XDIS10</StatisticalCode>
					<xsl:for-each select="$Dtm">
						<Authorisation>
							<xsl:call-template name="DTM203ToDateTime"/>
						</Authorisation>
					</xsl:for-each>
					<TypeCode>XDIS10</TypeCode>
					<StatusCode>
