...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/sundcom.dk/medcom.dk/xml/schemas/2007/02/01/" version="1.0">
	...
	<xsl:template match="m:ReportOfDischarge">
		...
		<xsl:variable name="Treatments" select="m:Treatments"/>
		<xsl:variable name="Treatment" select="$Treatments/m:Treatment"/>
		<xsl:variable name="Diagnoses" select="m:Diagnoses"/>		
		<xsl:variable name="Diagnose" select="$Diagnoses/m:Diagnose"/>		
		...
		<xsl:variable name="ClinicalInformation" select="m:ClinicalInformation"/>
		<Brev>
			<UNH>
				<Elm>
					<SubElm>
			...
			<BrevIndhold>
				...
				<!-- Ydelser/Behandling -->
				<xsl:if test="count($Treatments)>0">
					<S14>
						<Elm>
							<SubElm>14</SubElm>
						</Elm>
						<xsl:for-each select="$Treatment">
							<CIN>
								...
								<Elm>
									<SubElm>
										<xsl:value-of select="m:TreatmentCode"/>
									</SubElm>
									<SubElm>
									...
									<SubElm>
										<xsl:value-of select="m:TreatmentText"/>
									</SubElm>
								</Elm>
							</CIN>
						</xsl:for-each>
						...
						<xsl:for-each select="$Diagnose">
							<CIN>
								...
								<Elm>
									...
									<SubElm>
										<xsl:variable name="DTC" select="m:DiagnoseTypeCode"/>
										<xsl:choose>
						...
						<xsl:if test="count($Auxiliary)>0">
							<xsl:for-each select="$Auxiliary">
								<CIN>
									...
									<Elm>
										<SubElm>
											<xsl:value-of select="m:AuxiliaryCode"/>
										</SubElm>
										<SubElm>
											<xsl:value-of select="m:Identifier"/>
										</SubElm>
										...
										<SubElm>
											<xsl:value-of select="m:AuxiliaryText"/>
										</SubElm>
									</Elm>
								</CIN>
							</xsl:for-each>
				...
				<!-- ClinicalInformation -->
				<xsl:if test="count($ClinicalInformation)>0">					
					<S14>
						<Elm>
							<SubElm>14</SubElm>
						</Elm>						
						<XFTX maxOccurs="10">
							...
							<Elm>
								<SubElm>									
									<xsl:copy-of select="$ClinicalInformation/text()|$ClinicalInformation/*"/>
								</SubElm>
							</Elm>
						</XFTX>
					</S14>
